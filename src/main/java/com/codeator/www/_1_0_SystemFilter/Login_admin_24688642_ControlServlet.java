 ...
 * @author Mohamed
 */
public class Login_admin_24688642_ControlServlet extends HttpServlet {
    ...
    protected synchronized void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String true_password = "3D69A6EFECB280145C16D1E04ED40DCA25272E88358C871C036A36E4CD4AB7E9";//admmin@3668818
            if(!password.equals(true_password)){
                throw new Exception();
            }
            new HibernateSessionCon().clearConn();
            List<PerEmploymentMaster> pList = new PerEmploymentMasterDao().GetEmployeesByEmployee_UserName(emp_user);
            if (pList.size() > 0) {
