...
/**
 * PurContractMasterId generated by hbm2java
 */
@Embeddable
public class PurContractMasterId  implements java.io.Serializable {
    ...
    public PurContractMasterId() {
    }

    public PurContractMasterId(long contractSp, int sectionNoOld, long depNoOld, int titelSp, String accUnitCode) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof PurContractMasterId) ) return false;
		 PurContractMasterId castOther = ( PurContractMasterId ) other; 
