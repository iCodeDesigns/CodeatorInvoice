...
/**
 * VcleDistributeDateAhramPm generated by hbm2java
 */
@Entity
@Table(name="VCLE_DISTRIBUTE_DATE_AHRAM_PM"
    ,schema="CODEATOR"
)
public class VcleDistributeDateAhramPm  implements java.io.Serializable {


     private VcleDistributeDateAhramPmId id;
    ...
    public VcleDistributeDateAhramPm() {
    }

	
    public VcleDistributeDateAhramPm(VcleDistributeDateAhramPmId id, VcleEmployeeMaster vcleEmployeeMaster, VcleDistributeLocation vcleDistributeLocation, VcleDistributeDate vcleDistributeDate) {
        this.id = id;
    ...
    public VcleDistributeDateAhramPm(VcleDistributeDateAhramPmId id, VcleEmployeeMaster vcleEmployeeMaster, VcleDistributeLocation vcleDistributeLocation, VcleDistributeDate vcleDistributeDate, Date execMm, BigDecimal val, Boolean chkLock) {
       this.id = id;
       this.vcleEmployeeMaster = vcleEmployeeMaster;
       this.vcleDistributeLocation = vcleDistributeLocation;
       this.vcleDistributeDate = vcleDistributeDate;
    ...
    public VcleDistributeDateAhramPmId getId() {
        return this.id;
    }
    
    public void setId(VcleDistributeDateAhramPmId id) {
        this.id = id;
    }
