 ...
 */
package com.codeator.www._1_3_DB_generate_schema;
...
public class SchemaGeneratorDemo {
    ...
    public static final String SCRIPT_FILE = "codeator.sql";
    ...
    public static void main(String[] args) {
        ...
        String configFileName = "oracle/hibernate.cfg.vehicle.xml";
