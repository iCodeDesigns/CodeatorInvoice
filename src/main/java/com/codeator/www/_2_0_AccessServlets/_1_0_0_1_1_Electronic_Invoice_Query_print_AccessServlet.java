 ...
 * @author Mohamed
 */
public class _1_0_0_1_1_Electronic_Invoice_Query_print_AccessServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getSession().setAttribute("inv_sp", inv_sp);
        request.getSession().setAttribute("lang", lang);
        request.getSession().setAttribute("searchType", "*");
        request.getSession().setAttribute("Numbers_Of_Invoices", "1");
