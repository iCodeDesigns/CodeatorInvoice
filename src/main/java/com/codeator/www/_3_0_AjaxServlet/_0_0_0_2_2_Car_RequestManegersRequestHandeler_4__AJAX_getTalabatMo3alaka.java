 ...
 * @author Mahmoud
 */
public class _0_0_0_2_2_Car_RequestManegersRequestHandeler_4__AJAX_getTalabatMo3alaka extends HttpServlet {
    ...
    protected synchronized void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String HTML_DIV = "";
            int shownRows = 0;
            List<VcleVehicleRequire> vList = new VcleVehicleRequireDao().GetVcleVehicleRequireByDepNoOld(DeptNoOld, "2");
            ...
            if (vList.size() > 0) {
                for (VcleVehicleRequire v : vList) {
                    ...
                    HTML_DIV += "<tr>\n"
                            ...
                            + "    <td id=\"cell2" + v.getRequireSp() + "\">\n"
                            + "        <button type=\"button\" class=\"btn btn-custon-rounded-three btn-danger\" onclick=\"DeleteRequest2('" + v.getRequireSp() + "');\"><i class=\"fa fa-trash adminpro-warning-danger\" aria-hidden=\"true\"></i> حذف</button>\n"
                            + "    </td>\n"
                            + "</tr>";
