 ...
 * @author Moham
 */
public class _0_0_0_2_2_Car_RequestManegersRequestHandeler_6__AJAX_setEmployeeNoApprovalToVcleVehicleRequire extends HttpServlet {
    ...
    protected synchronized void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String EmployeeEnchuranceNumber = request.getParameter("EmployeeEnchuranceNumber");
            List<VcleVehicleRequire> vList = dao.GetVcleVehicleRequireByRequireSp(RequireSp);
            VcleVehicleRequire v = vList.get(0);

            List<VcleVehicleRequireStatus> vvrsList = new VcleVehicleRequireStatusDao().GetVcleVehicleRequireByRequireStatus("2");
            if (vvrsList.isEmpty()) {
                throw new Exception();
            }
            ...
            v.setEmployeeNoApproval(Long.parseLong(EmployeeEnchuranceNumber));
            ...
            VcleVehicleRequireStatusDt vvrsd = new VcleVehicleRequireStatusDt(vvrsdi, vvrs, v, employee_session, employee_session.getEmployeeNo(), "", new DateOp().getCustomSysDate("yyyy-MM-dd HH:mm:ss"), new DateOp().getSysDate());
