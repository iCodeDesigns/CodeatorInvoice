 ...
 * @author Mahmoud
 */
public class _0_0_0_2_3_Car_Request_2__AJAX_set1ToRequireStatusToVcleVehicleRequire extends HttpServlet {
    ...
    protected synchronized void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<VcleVehicleRequireStatus> vvrsList = new VcleVehicleRequireStatusDao().GetVcleVehicleRequireByRequireStatus("12");
            if (vvrsList.isEmpty()) {
                throw new Exception();
            }
