 ...
 * @author Support
 */
public class _0_0_0_2_4_Car_RequestTranspoetOfficeFinalAction_11__AJAX_getRequestsOfRunningTrips extends HttpServlet {
    ...
    protected synchronized void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<VcleRecordMovement> vMovementList = new VcleRecordMovementDAO().GetVcleRecordMovementByGopingSp(GoingSp);
            String HTML_DIV = "";
            Set<VcleRecordMovementJoin> vrmjList = vMovementList.get(0).getVcleRecordMovementJoins();
