 ...
 * @author Mahmoud
 */
public class _0_0_0_2_4_Car_RequestTranspoetOfficeFinalAction_6__AJAX_getDriverTrip extends HttpServlet {
    ...
    protected synchronized void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String emp_Driver_id = request.getParameter("emp_Driver_id");
            String HQL = " v.comingDate=null AND v.perEmploymentMaster.employeeId='" + emp_Driver_id + "'";
