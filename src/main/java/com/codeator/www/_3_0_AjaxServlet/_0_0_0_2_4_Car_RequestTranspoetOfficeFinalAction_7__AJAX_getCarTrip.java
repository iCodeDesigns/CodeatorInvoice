 ...
 * @author Mahmoud
 */
public class _0_0_0_2_4_Car_RequestTranspoetOfficeFinalAction_7__AJAX_getCarTrip extends HttpServlet {
    ...
    protected synchronized void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String HQL = " v.comingDate=null AND v.vcleVehicleMaster.boardNumber='" + BoardNumber + "' ";

            String HTML_DIV = "";
            List<VcleRecordMovement> vList = new VcleRecordMovementDAO().GetVcleRecordMovementCustomQuery(HQL);
            if (vList.isEmpty()) {
                long last_movment_counter = new VcleRecordMovementDAO().GetLastVcleCountNumber(BoardNumber);
                HTML_DIV = ""+last_movment_counter;
            } else {
                //int i = 0;
                HTML_DIV = getUpperTableText();
    ...
    private String getUpperTableText() {
        return "<table class=\"table table-striped table-bordered\" style=\"text-align: center;\" >"
                + "<thead>\n"
                + "                                                                        <tr>          \n"
