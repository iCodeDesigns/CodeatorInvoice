 ...
 * @author Mahmoud
 */
public class _0_0_0_2_6_Car_Request_1__AJAX_addToVcleVehicleRequire extends HttpServlet {
    ...
    protected synchronized void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ////////////////////////////////////////////////
            List<VcleVehicleRequireStatus> vvrsList = new VcleVehicleRequireStatusDao().GetVcleVehicleRequireByRequireStatus("11");
            if (vvrsList.isEmpty()) {
                throw new Exception();
            }
