 ...
 * @author Mohamed
 */
public class _0_0_0_2_9_Vcle_Traffic_Emp_Perm_Query_Main_Ajax_7_getValDashByMonth extends HttpServlet {
    ...
    protected synchronized void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<BigDecimal> valList = new VcleTrafficEmpPermDao().GetVcleTrafficEmpPermByMonthFeat(Month);

            VcleTrafficEmpPerm_Query_Jason[] vcleTrafficEmpPerm_Query_Jason_arr = new VcleTrafficEmpPerm_Query_Jason[valList.size()];
            ...
            for (BigDecimal val : valList) {
                ...
                vcleTrafficEmpPerm_Query_Jason2.setVal("" + val);

                long emp_count = new VcleTrafficEmpPermDao().GetCountEmployeeByMonthAndVal(Month, val.toString());
                vcleTrafficEmpPerm_Query_Jason2.setCountEmployeeIdInMonth("" + emp_count);
