 ...
 * @author Moham
 */
public class _0_0_0_4_5_1_Employees_Auth_Ajax_6_addToACCUnit_AjaxServlet extends HttpServlet {
    ...
    protected synchronized void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            appAuthJavaUsers.setInvoAccUintDept(invoAccUintDeptDaoList.get(0));
