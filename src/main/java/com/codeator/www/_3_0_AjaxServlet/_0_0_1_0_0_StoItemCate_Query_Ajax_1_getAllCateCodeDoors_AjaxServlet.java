...
import com.codeator.www._1_3_DB_daos.StoItemCateCodeDao;
 ...
 * @author Mohamed
 */
public class _0_0_1_0_0_StoItemCate_Query_Ajax_1_getAllCateCodeDoors_AjaxServlet extends HttpServlet {
    ...
    protected synchronized void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<StoItemCateCode> siccList = new StoItemCateCodeDao().GetAllStoItemCateCode();

            StoItemCate_Query_Jason[] stoItemCate_Query_Jason_arr = new StoItemCate_Query_Jason[siccList.size()];

            int i = 0;
            for (StoItemCateCode sicc : siccList) {
                StoItemCate_Query_Jason stoItemCate_Query_Jason2 = new StoItemCate_Query_Jason();
                stoItemCate_Query_Jason2.setCateCode(sicc.getCateCode());
                stoItemCate_Query_Jason2.setCateName(sicc.getCateName());
                
                String HQL;
                HQL = "s.cateCode= " + sicc.getCateCode() + " ";
                long Count = new StoResponsibilityHistoryEmpDao().GetCountEmployeesRespsByRespTypeActNot9(HQL);
                stoItemCate_Query_Jason2.setCateCodeTotal(""+Count);
                
                long CountDept = new StoResponsibilityDeptDao().GetCountDeptRespsByRespTypeActNot9(HQL);
                stoItemCate_Query_Jason2.setCateCodeDeptTotal(""+CountDept);
