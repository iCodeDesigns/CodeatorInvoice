 ...
 * @author Mohamed
 */
public class _1_0_0_0_1_Electronic_Invoice_Submit_02_Client_Info_002_QueryByReceiverId extends HttpServlet {
    ...
    protected synchronized void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<PurSuppWork> pList = new PurSuppWorkDao().GetPurSupplierWorkById(id, receiverType);
            ...
            for (PurSuppWork purSuppWork : pList) {
                ...
                String id_1 = temp_id == null ? "" : temp_id.replaceAll("[/-]*", "");
