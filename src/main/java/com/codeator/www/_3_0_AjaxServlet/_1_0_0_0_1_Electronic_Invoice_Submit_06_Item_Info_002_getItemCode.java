 ...
 * @author Moham
 */
public class _1_0_0_0_1_Electronic_Invoice_Submit_06_Item_Info_002_getItemCode extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<InvoItemCode> pList = new InvoItemCodeDAO().GetInvItemCodeForDeptAndCodeType(accUnitId, depNoOld, sectionNoOld, itemType);

            _200_Submit_Documents_008_invoiceLine[] items = new _200_Submit_Documents_008_invoiceLine[pList.size()];

            int i = 0;
            for (InvoItemCode item : pList) {
                ...
                r.setDescription(item.getAItemName());
                items[i] = r;
                i++;
            }
            ObjectMapper mapper = new ObjectMapper();
