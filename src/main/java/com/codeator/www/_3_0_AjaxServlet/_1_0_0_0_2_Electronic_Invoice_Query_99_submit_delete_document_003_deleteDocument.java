 ...
 * @author Moham
 */
public class _1_0_0_0_2_Electronic_Invoice_Query_99_submit_delete_document_003_deleteDocument extends HttpServlet {
    ...
    protected synchronized void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //get document status
            List<InvoDocumentStatus> invoDocumentStatusList = new InvoDocumentStatusDAO<>().GetInvoDocumentStatusByDocStatus("0");// محذوف
