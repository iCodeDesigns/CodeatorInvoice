 ...
 * @author Moham
 */
public class _1_0_0_0_2_Electronic_Invoice_Query_99_submit_review_document_004_reviewDocument extends HttpServlet {
...
//            }
            //get document status
            List<InvoDocumentStatus> invoDocumentStatusList = new InvoDocumentStatusDAO<>().GetInvoDocumentStatusByDocStatus("4");// مراجعة
