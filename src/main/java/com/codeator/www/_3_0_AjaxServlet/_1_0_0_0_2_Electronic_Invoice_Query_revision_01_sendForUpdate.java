 ...
 * @author Moham
 */
public class _1_0_0_0_2_Electronic_Invoice_Query_revision_01_sendForUpdate extends HttpServlet {
    ...
    protected synchronized void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //get document status
            List<InvoDocumentStatus> invoDocumentStatusList = new InvoDocumentStatusDAO<>().GetInvoDocumentStatusByDocStatus("3");// مرتجع مراجعة
