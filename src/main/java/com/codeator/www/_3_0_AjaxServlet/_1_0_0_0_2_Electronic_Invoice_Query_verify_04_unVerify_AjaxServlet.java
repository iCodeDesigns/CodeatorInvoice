 ...
 * @author Mohamed
 */
public class _1_0_0_0_2_Electronic_Invoice_Query_verify_04_unVerify_AjaxServlet extends HttpServlet {
    ...
    protected synchronized void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //get document status
            List<InvoDocumentStatus> invoDocumentStatusList = new InvoDocumentStatusDAO<>().GetInvoDocumentStatusByDocStatus("6");// تم الإعتماد
