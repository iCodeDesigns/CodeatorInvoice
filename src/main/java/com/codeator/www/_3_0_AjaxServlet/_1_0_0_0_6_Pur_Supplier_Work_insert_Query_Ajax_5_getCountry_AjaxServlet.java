 ...
 * @author Mohamed
 */
public class _1_0_0_0_6_Pur_Supplier_Work_insert_Query_Ajax_5_getCountry_AjaxServlet extends HttpServlet {
    ...
    protected synchronized void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            _200_Submit_Documents_004_address[] country_gov_list = new _200_Submit_Documents_004_address[PerCountryCodeList.size()];
            int i = 0;
            for (PerCountryCode p : PerCountryCodeList) {
                ...
                country_gov.setCountryCode(p.getCountryCode());
                country_gov.setCountry(p.getACountryName());
