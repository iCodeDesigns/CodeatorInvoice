 ...
 * @author Moham
 */
public class _1_0_0_0_9_Invo_Item_Tax_Unit_Join_08_DeleteItemDescDtl_AjaxServlet extends HttpServlet {
    ...
    protected synchronized void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            InvoDeptItemJoinDescDtl InvoDesc = invoDeptItemJoinDescDtl.get(0);

            new HibernateSessionCon().beginTrans();
            new InvoDeptItemJoinDescDtlDAO().delete(InvoDesc);
