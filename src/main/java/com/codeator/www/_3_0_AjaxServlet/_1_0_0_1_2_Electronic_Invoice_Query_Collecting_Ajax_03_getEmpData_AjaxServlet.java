 ...
 * @author Mohamed
 */
public class _1_0_0_1_2_Electronic_Invoice_Query_Collecting_Ajax_03_getEmpData_AjaxServlet extends HttpServlet {
    ...
    protected synchronized void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<PerEmploymentMaster> pList = new PerEmploymentMasterDao().GetEmployeesByEmployee_IDByDeptOnly(employeeId, deptId, sectionId);
