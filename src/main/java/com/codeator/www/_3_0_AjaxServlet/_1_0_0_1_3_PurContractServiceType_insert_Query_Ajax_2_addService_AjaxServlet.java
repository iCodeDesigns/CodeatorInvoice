 ...
 * @author Mohamed
 */
public class _1_0_0_1_3_PurContractServiceType_insert_Query_Ajax_2_addService_AjaxServlet extends HttpServlet {
    ...
    protected synchronized void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            long serviceSeq = new PurContractServiceTypeDao<>().GetMaxServiceSeq();
            ...
            PurContractServiceType purContractServiceType = new PurContractServiceType(serviceSeq, perDeptOld.get(0), "1");

            purContractServiceType.setServiceName(serviceName);
            purContractServiceType.setServiceCode(serviceCode);
            purContractServiceType.setInsertDate(new DateOp().getSysDate());
            purContractServiceType.setInsertDateTime(new DateOp().getCustomSysDate("yyyy-MM-dd HH:mm:ss"));
            purContractServiceType.setPerEmploymentMaster(perEmploymentMaster.get(0));

            new HibernateSessionCon().beginTrans();
            new PurContractServiceTypeDao().insert(purContractServiceType);
            ...
            response.getWriter().write("حدث خطأ");
        }
