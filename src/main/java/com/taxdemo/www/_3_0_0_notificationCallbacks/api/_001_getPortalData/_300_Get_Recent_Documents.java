 ...
 * @author Moham
 */
public class _300_Get_Recent_Documents {

    private final _300_Get_Recent_Documents_JSON_000_ get_Recent_Documents_JSON;
     ...
     * @throws IOException
     */
    public _300_Get_Recent_Documents(String idSrvBaseUrl, String token_type, String access_token, String PageSize, String PageNo) throws IOException {
        ...
        Request request = new Request.Builder()
                .url(idSrvBaseUrl + "/api/v1.0/documents/recent?PageSize=" + PageSize + "&PageNo=" + PageNo)
                .method("GET", null)
        ...
        this.get_Recent_Documents_JSON = mapper.readValue(json, _300_Get_Recent_Documents_JSON_000_.class);
