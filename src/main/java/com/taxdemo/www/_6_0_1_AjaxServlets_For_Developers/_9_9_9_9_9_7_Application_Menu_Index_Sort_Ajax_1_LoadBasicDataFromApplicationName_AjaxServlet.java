 ...
 * @author Moham
 */
public class _9_9_9_9_9_7_Application_Menu_Index_Sort_Ajax_1_LoadBasicDataFromApplicationName_AjaxServlet extends HttpServlet {
    ...
    protected synchronized void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (pList.isEmpty()) {
                ...
                for (AppName p : pList) {
                    HTML_TEXT += "<tr>\n"
                            + "                    <td style=\"font-weight: bold;\" class='application_id'>" + p.getApplicationId() + "</td>\n"
                            + "                    <td style=\"font-weight: bold;\">" + p.getApplicationName() + "</td>\n"
                            + "                    <td style=\"font-weight: bold;\"><input style=\"text-align: center;\" name=\"ApplicationIndex\" type=\"text\" class=\"form-control\" value=\"" + ((p.getApplicationIndex() == null) ? p.getApplicationId() : p.getApplicationIndex()) + "\" readonly=\"\"></td>\n"
                            + "</td>\n";
                }
            }
