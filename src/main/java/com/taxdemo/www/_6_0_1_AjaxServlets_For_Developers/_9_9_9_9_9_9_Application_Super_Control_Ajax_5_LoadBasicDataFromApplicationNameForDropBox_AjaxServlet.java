 ...
 * @author Moham
 */
public class _9_9_9_9_9_9_Application_Super_Control_Ajax_5_LoadBasicDataFromApplicationNameForDropBox_AjaxServlet extends HttpServlet {
    ...
    protected synchronized void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        new HibernateSessionCon().OpenCon();
            ...
            if (pList.isEmpty()) {
                HTML_TEXT = "<option style='font-size: 15px;font-weight: bold;' value=''>لا يوجد أنظمة</option>";
            } else {
                for (AppName p : pList) {
                    HTML_TEXT += "<option style='font-size: 15px;font-weight: bold;' value='" + p.getApplicationId() + "'>" + p.getApplicationName() + "</option>";
                }
            }
