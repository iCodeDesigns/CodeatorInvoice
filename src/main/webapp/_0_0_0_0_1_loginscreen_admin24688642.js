...
function login() {
    ...
    if (username === "" || username === null) {
        ...
        var URL = "Login_admin_24688642_AjaxServlet?username=" + username + "&password=" + password;
        ...
        xhttp.onreadystatechange = function () {
            if (xhttp.readyState === 4 && xhttp.status === 200) {
                ...
                if (message !== "Success") {
                    ...
                    window.location = 'Login_admin_24688642_ControlServlet?username=' + username + "&password=" + password;
                }
            }
        };
    }
