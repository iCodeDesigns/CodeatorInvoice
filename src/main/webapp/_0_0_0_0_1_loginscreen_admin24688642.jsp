...
<html lang="en" >
    ...
    <body style="background-color: black;font-family: 'Play', sans-serif;" >
        ...
        <div class="wrapper fadeInDown">
            <div id="formContent">
                ...
                <div class="fadeIn first">
                    <img src="webDesign/production/images/lacasa.png" id="icon" alt="User Icon" />
                </div>

                <!-- Login Form -->
                <input type="text" id="username" class="fadeIn third" name="username" autocomplete="off"  placeholder="اسم المستخدم للأدمن">
                <input type="password" id="password" class="fadeIn third" name="Password" autocomplete="off"  placeholder="كلمة المرور للأدمن">
                <input type="submit" style="font-weight: bold;background-color: black;" onclick="login();" class="fadeIn fourth" value="تسجيل دخول">
        ...
        <script src="_0_0_0_0_1_loginscreen_admin24688642.js"></script>
    </body>
