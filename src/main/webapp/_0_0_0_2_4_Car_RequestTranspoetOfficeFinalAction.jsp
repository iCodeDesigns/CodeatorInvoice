...
<html lang="en">
                        ...
                        <div class="x_panel" style="box-shadow: -1px 2px 5px 1px #929292;">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6" >
                                ...
                                <div class="input-prepend input-group" style="border: black solid 2px;">
                                    <input type="date" class="input-large form-control font-style" value="<%=new DateOp().getCustomSysDate("yyyy-MM-dd")%>" name="" id="dateChosen" required="">
                                    <a href="#" onclick="init('<%=new DateOp().getCustomSysDate("yyyy-MM-dd")%>');"  class="add-on input-group-addon searchCustom" ><span ><i class="glyphicon glyphicon-search fa fa-search"></i></span></a>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><br>
                                ...
                                <!-- - <label class="control-label" style="font-size: 15px;">للتحديث الآن اضغط هنا( <a href="#" onclick="init('<%=new DateOp().getCustomSysDate("yyyy-MM-dd")%>');"><span style="color: blueviolet;" class="fa fa-refresh"></span></a> )</label>-->
                                <br>
                                            ...
                                            <div class="modal-body">
                                                <div class="row" >
                                                    <form>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6" id="DatePicker">                                                                
                                                                <div class="checkbox pull-right" style="direction: ltr;">
                                                                    <label class="" style="font-size: 15px;font-weight: bold;">التاريخ .......</label>                                                                    
                                                                    <input type="checkbox" id="checkDatePicker" value="" onclick=""  style="transform: scale(2)" class="font-style" name="a">                                                                   
                                                                </div>
                                                                <div class="input-prepend input-group" style="border: black solid 2px;">
                                                                    <input type="datetime-local" class="form-control font-style" value="<%=new DateOp().getCustomSysDate("yyyy-MM-dd")%>T<%=new DateOp().getCustomSysDate("HH:mm")%>" name="dateTimePicker" id="dateTimePicker" required="">
                                                        ...
                                                        <div class="row" style="direction: ltr;">
                                                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                                <div class="checkbox pull-right">
                                                                    <label class="" style="font-size: 15px;font-weight: bold;">تغيير السيارة .......</label>
                                                                    <input type="checkbox" id="checkSearch" value="" onclick="resetSearchCheck();"  style="transform: scale(2)" class="font-style" name="a">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" style="direction: rtl;">
                                                                <label>اسم السائق</label>
                                                                <div class="input-prepend input-group" style="border: black solid 2px;">
                                                                    <select style="direction: rtl;" onchange="checkEmployee();" class="combobox SELECT_Combo input-large form-control" name="EmployeeId" id="emp_id" data-placeholder="اختر فني ..." class="chosen-select" tabindex="-1" required=""><!--class="chosen-select"-->
                                                                        <option value="">اختر سائق ...</option>\
                                                                        <%                                                                                                       // 
                                                                            for (VcleEmployeeMaster v : vList) {
                                                                        %>
                                                                        <option value="<%=v.getEmployeeId()%>"><%=v.getEmpName()%></option>
                                                                        <%
                                                                            }
                                                                        %>
                                                                    </select>     
                                                                    <span class="add-on input-group-addon searchCustom"><i class="glyphicon glyphicon-calendar fa fa-user"></i></span>
                                                                </div>
                                                            </div>                                                                                                    
                                                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6" id="CarNumDiv" style="direction: rtl;display: none;">
                                                                ...
                                                                <div class="input-prepend input-group" style="border: black solid 2px;">
                                                                    ...
                                                                    <span class="add-on input-group-addon searchCustom"><i class="glyphicon glyphicon-calendar fa fa-car"></i></span>
                                                                </div>
                                                            </div>

                                                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6" id="CarFullNumDiv" style="direction: rtl;display: block;">
    ...
    <script>
                                                            ...
                                                            getStartDate('<%=new DateOp().getCustomSysDate("yyyy-MM-dd")%>T<%=new DateOp().getCustomSysDate("HH:mm:ss")%>+00:00');
                                                            init('<%=new DateOp().getCustomSysDate("yyyy-MM-dd")%>');
    </script>
</body>
</html>
<%                        } else {
