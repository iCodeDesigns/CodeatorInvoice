        ...
        if (EmployeeId === "" || EmployeeId === null) {
            ...
            if (BoardNumber === "" || BoardNumber === null) {
                ...
                if (GuestNumOfCar < RequestGuestNumber) {
                    ...
                    if ((goingCountNumber === "" || goingCountNumber === null) && (!goingCountNumberStatus)) {
...
function LoadRequestsCount() {
    var xhttp = new XMLHttpRequest();
    xhttp.open("POST", "_0_0_0_2_4_Car_RequestTranspoetOfficeFinalAction_8__AJAX_LoadRequestsCount?", true);
    xhttp.send();
    xhttp.onreadystatechange = function ()
    {
        if (xhttp.readyState === 4 && xhttp.status === 200)
...
function LoadRequestsTable() {
    var xhttp = new XMLHttpRequest();
    xhttp.open("POST", "_0_0_0_2_4_Car_RequestTranspoetOfficeFinalAction_9__AJAX_LoadRequestsTable?", true);
    xhttp.send();
    xhttp.onreadystatechange = function ()
    {
        if (xhttp.readyState === 4 && xhttp.status === 200)
