...
<%@page import="com.codeator.www._1_3_DB_daos.VcleVehicleModelDao"%>
<%@page import="com.codeator.www._1_2_DB_entities.VcleVehicleModel"%>
...
<html lang="en">
    <head>
        ...
        <title>استعلام عن سائقي السيارات</title>
        ...
        <style>
            ...
            /* خاص بالكومبو السيرش بيقلب الليستة ناحية اليمين */
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_right">
                                <h3 style="font-weight: bold;">استعلام عن سائقي السيارات</h3>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        ...
                        <div class="x_panel" style="box-shadow: -1px 2px 5px 1px #929292;">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                ...
                                <select type="text" placeholder="نوع البحث" onchange="searchType();" id="searchType" maxlength="45" name="searchType" class="form-control font-style" required="">
                                    ...
                                    <option value="CarNumber" class="font-style"> برقم المركبة..</option>
                                    <option value="CarModel" class="font-style"> بموديل المركبة..</option>
                                    <option value="CarType" class="font-style"> بنوع المركبة..</option>
                                    <option value="Driver" class="font-style">بالسائق ..</option>
                                </select>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" id="DriverDiv" Style="display: none;">
                                <label class="control-label font-style">اسم السائق</label>
                                <select data-placeholder="اختر سائق ..." name="EmployeeId" id="EmployeeId" class="form-control SELECT_Combo font-style" tabindex="-1" required="">
                                    <option value="" class="font-style SELECT_Combo">اختر سائق ...</option>
                                    <%
                                        List<VcleVehicleDriverJoin> vvdjList = new VcleVehicleDriverJoinDAO().GetAllVcleVehicleDriverJoin();
                                        if (vvdjList.isEmpty()) {

                                        } else {
                                            for (VcleVehicleDriverJoin vvdj : vvdjList) {
                                    %>
                                    <option class="font-style" value="<%=vvdj.getId().getEmployeeId()%>"><%=vvdj.getPerEmploymentMaster().getEmpAname()%></option>
                                    <%
                                            }
                                        }
                                    %>
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12" id="CarNumberDiv" Style="display: none;">
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    <label class="control-label font-style">أرقام المركبات</label>
                                    <select class="form-control SELECT_Combo font-style" id="BoardNumber"  data-placeholder="اختر الأرقام ..." tabindex="-1" required="">
                                        <option value="" class="font-style">اختر الأرقام ...</option>
                                        <%
                                            List<VcleVehicleDriverJoin> vvdjoList = new VcleVehicleDriverJoinDAO().GetAllVcleVehicleDriverJoinOrderByVcleNumber();
                                            if (vvdjoList.isEmpty()) {

                                            } else {
                                                for (VcleVehicleDriverJoin vvdjo : vvdjoList) {
                                        %>
                                        <option class="font-style" value="<%=vvdjo.getBoardNumber()%>"><%=vvdjo.getBoardNumber()%></option>
                                        <%
                                                }
                                            }
                                        %>
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12" id="CarModelDiv" Style="display: none;">
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    <label class="control-label font-style">موديلات المركبات</label>
                                    <select class="form-control SELECT_Combo font-style" id="ModelCode"  data-placeholder="اختر موديل ..." tabindex="-1" required="">
                                        <option value="" class="font-style">اختر موديل ...</option>
                                        <%
                                            List<VcleVehicleModel> vvmList = new VcleVehicleModelDao().GetAllVehiclesModels();
                                            if (vvdjoList.isEmpty()) {

                                            } else {
                                                for (VcleVehicleModel vvm : vvmList) {
                                        %>
                                        <option class="font-style" value="<%=vvm.getId().getModelCode()%>-<%=vvm.getId().getMarkType()%>-<%=vvm.getId().getVcleType()%>"><%=vvm.getVcleMarkType().getMarkName()%> - <%=vvm.getModelName()%></option>
                                        <%
                                                }
                                            }
                                        %>
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12" id="CarTypeDiv" Style="display: none;">
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    <label class="control-label font-style">أنواع المركبات</label>
                                    <select class="form-control SELECT_Combo font-style" id="VcleType"  data-placeholder="اختر نوع ..." tabindex="-1" required="">
                                        <option value="" class="font-style">اختر نوع ...</option>
                                        <%
                                            List<VcleVehicleType> vvtList = new VcleVehicleTypeDao().GetAllVehicles();
                                            if (vvtList.isEmpty()) {

                                            } else {
                                                for (VcleVehicleType vvt : vvtList) {
                                        %>
                                        <option class="font-style" value="<%=vvt.getVcleType()%>"><%=vvt.getVcleTypeName()%></option>
                                        <%
                                                }
                                            }
                                        %>
                                ...
                                <table id="" class="table table-striped table-bordered table-hover">
                                    <thead style="background-color: #131e33;color: white;">
                                        <tr>
                                            ...
                                            <th style="text-align: center;font-size: 15px;width: 20%">اسم السائق</th>
                                            <th style="text-align: center;font-size: 15px;width: 15%">نوع السيارة</th>
                                            <th style="text-align: center;font-size: 15px;width: 15%">موديل السيارة</th>
                                            <th style="text-align: center;font-size: 15px;width: 15%">رقم السيارة</th>
                                    ...
                                    <tbody id="VcleVehicleDriverJoin_Data" style="text-align: center;">
                                    </tbody>
                                </table>
                            </div>
    ...
    <script src="_0_0_0_2_7_Vehicle_Driver_Join_query.js"></script>
