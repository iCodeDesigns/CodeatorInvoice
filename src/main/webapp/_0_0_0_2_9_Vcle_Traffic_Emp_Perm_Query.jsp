...
<%@page import="com.codeator.www._1_2_DB_entities.VcleTrafficEmpPerm"%>
...
<html lang="en">
    <head>
        ...
        <title>استعلام عن الاشتراكات</title>
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_right">
                                <h3 style="font-weight: bold;">استعلام عن الاشتراكات</h3>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        ...
                        <div class="x_panel" style="box-shadow: -1px 2px 5px 1px #929292;">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="execSearchTypeDiv">
                                    <label class="control-label font-style">الفترة</label>
                                    <select type="text" placeholder="نوع البحث" onchange="execSearchType();" id="execSearchType" maxlength="45" name="execSearchType" class="form-control font-style" required="">
                                        <option value="" class="font-style">اختر فترة..</option>
                                        <option value="DateFromTo" class="font-style">فترة معينة..</option>
                                        <option value="Month" class="font-style">شهر معين..</option>
                                    </select>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="execMmDiv" Style="display: none;">
                                    <label class="control-label font-style">الشهر</label>
                                    <select data-placeholder="اختر فئة ..." name="execMm" id="execMm" onchange="displaySearchTypeDiv();" class="form-control SELECT_Combo font-style" tabindex="-1" required="">
                                        <option value="" class="font-style">اختر الشهر ...</option>
                                        <%
                                            ...
                                            if (vtepeList.isEmpty()) {
                                                ...
                                                for (Date vtepe : vtepeList) {
                                                    String date_str = new DateOp().Date2String(vtepe, "yyyy-MM");
                                        %>
                                        <option class="font-style" value="<%=vtepe%>"><%=date_str%></option>
                                        <%
                                                }
                                            }
                                        %>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="RangDateDiv" Style="display: none;">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                                        <label class="control-label font-style">التاريخ من</label>                                                                  
                                        <input type="month" class="form-control" id="from_date" value="">
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                                        <label class="control-label font-style">التاريخ إلى</label>                                                                   
                                        <input type="month" class="form-control" id="to_date" onchange="displaySearchTypeDiv();" value="">
                                    </div>
                                </div>

                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="searchTypeDiv" style="display: none;">
                                    ...
                                    <select type="text" placeholder="نوع البحث" onchange="searchType();" id="searchType" maxlength="45" name="searchType" class="form-control font-style" required="">
                                        ...
                                        <option value="EmpId" class="font-style">بالموظف..</option>
                                        <option value="Val" class="font-style">بفئة الاشتراك..</option>
                                    </select>
                                </div>                            

                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="EmpDiv" Style="display: none;">
                                    ...
                                    <select data-placeholder="اختر سائق ..." name="EmployeeId" id="EmployeeId" class="form-control SELECT_Combo font-style" tabindex="-1" required="">
                                        <option value="" class="font-style">اختر موظف ...</option>                                       
                                    </select>
                                    <span id="loadSpin"></span>
                                </div> 

                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="ValDiv" Style="display: none;">
                                    <label class="control-label font-style">فئات الاشتراك</label>
                                    <select data-placeholder="اختر فئة ..." name="Val" id="Val" class="form-control SELECT_Combo font-style" tabindex="-1" required="">

                                    </select> 
                                    <span id="loadSpin2"></span>
                                </div> 


                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group"><br>                                          
                                    <button type="button" data-placement="top" onclick="getDash();" class="buttonNext buttonDisabled btn btn-success fa fa-bar-chart" style="width: 85%; font-weight: bold;font-size: 17px;" data-toggle="modal" data-target="#x"> بيان إحصائي</button>                                    
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 form-group"><br>                                         
                                    <button type="button" data-placement="top" onclick="searchSubmitPrem();" class="buttonNext buttonDisabled btn btn-success fa fa-search" style="width: 85%; font-weight: bold;font-size: 17px;" data-toggle="modal" data-target="#x"> استعلام</button>                                    
                                </div>

                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group" id="DashTableLable" style="font-size: 17px;text-align: center;font-weight: bold;color: #961004;"></div>
                                    ...
                                    <table id="" class="table table-striped table-bordered table-hover">
                                        <thead style="background-color: #337ab7;color: white;">
                                            <tr>
                                                ...
                                                <th style="text-align: center;font-size: 15px;width: 15%">الإدارة</th>
                                                <th style="text-align: center;font-size: 15px;width: 15%">التاريخ</th>
                                                <th style="text-align: center;font-size: 15px;width: 15%">الفيمة</th>
                                            </tr>
                                        </thead>

                                        <!--<img src="webDesign/production/images/Spin-0.9s-200px.gif" alt="" border=1 height=50 width=50>-->

                                        <tbody id="LoadTrafficEmpPerm_Data" style="text-align: center;">
                                        </tbody>
                                    </table>
                                </div>
    ...
    <script src="_0_0_0_2_9_Vcle_Traffic_Emp_Perm_Query.js"></script>
