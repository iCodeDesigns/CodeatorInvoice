...
<html lang="en">
    ...
    <body class="nav-md" onload="TodayName();" style="color: #000000;" >
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_right">
                                <h3 style="font-weight: bold;">إحصائيات عن العهد</h3>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        <!--card Start -->
                                ...
                                <table class="table table-striped table-bordered table-hover" style="width: fit-content;border-style: hidden;">
                                    <tbody class="table-font-style" style="width: fit-content;">
                                        <tr>
                                            ...
                                            <td id="TotalDoorsEmp" style="text-align: right;border-style: hidden;color: #0068BA;"></td>
                                        </tr>
                                        <tr>
                                            <td style="text-align: right;border-style: hidden;">الإجمالي العام للعهد المكانية:</td>
                                            <td id="TotalDoorsDept" style="text-align: right;border-style: hidden;color: #0068BA;"></td>
                                        </tr>
                                        <tr>
                                            <td style="text-align: right;border-style: hidden;">الإجمالي العام للعهد:</td>
                                            <td id="TotalDoorsAll" style="text-align: right;border-style: hidden;color: #0068BA;"></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive">
                                <table id="" class="table table-striped table-bordered table-hover">
                                    <thead style="background-color: #131e33;color: white;">
                                        <tr>
                                            <th style="text-align: center;font-size: 15px;width: 15%">كود الباب</th>
                                            <th style="text-align: center;font-size: 15px;width: 15%">اسم الباب</th>
                                            <th style="text-align: center;font-size: 15px;width: 15%">إجمالي العهد الشخصية:<br><span id="TotalDoorsEmp1"></span></th>
                                            <th style="text-align: center;font-size: 15px;width: 15%">إجمالي العهد المكانية: <br><span id="TotalDoorsDept1"></span></th>
                                            <th style="text-align: center;font-size: 15px;width: 15%">إجمالي العهد:<br><span id="TotalDoorsAll1"></span></th>
        ...
        <script src="_0_0_1_0_0_StoItemCate_Query.js"></script>
