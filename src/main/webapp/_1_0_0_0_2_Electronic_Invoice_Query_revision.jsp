...
<%
    ...
    try {
        ...
        if (key.equals("Open")) {
            ...
            List<AppSubElemSpecAuth> asesaList = new AppSubElemSpecAuth_DAO().getEmpSubTabElementsSpecAuthInSubTab("" + employee_session.getEmployeeId(), "_1_0_0_0_2_Electronic_Invoice_Query_revision_AccessServlet");
...
<html lang="en">
    ...
    <body class="nav-md" onload="TodayName();" style="color: #000000;" >
        <div class="container body">
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_right">
                                <h3 style="font-weight: bold;">مراجعة الفواتير</h3>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        ...
                        <div class="x_panel" style="box-shadow: -1px 2px 5px 1px #929292;">
                            <!-- for Edit -->
                            <div class="row" style="color: #327ab7;">مراجعة الفواتير</div>                            
            ...
            <div class="modal fade" id="InvoiceUpdate" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="direction: rtl;">
                            <div class="row" >
                                <h1 style="color: #ae9167;;text-align: center">هل أنت متأكد من رفض هذا المستند ؟؟!...</h1>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="modal-footer" style="background-color: #ae9167;; text-align: center;font-size: 20px;font-weight: bold;">
                            ...
                            <button type="button" class="btn btn-default" onclick="sendInvoiceForUpdate();"  style="font-size: 20px;font-weight: bold;">نعم</button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal fade" id="InvoiceVerify" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="direction: rtl;">
                            <div class="row" >
                                <h1 style="color: #204d74;text-align: center">هل أنت متأكد من إرسال المستند للإعتماد ؟؟!...</h1>
                            </div>
                        </div>
                        <div class="modal-footer" style="background-color: #204d74; text-align: center;font-size: 20px;font-weight: bold;">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal" style="font-size: 20px;font-weight: bold;">لا</button>
                            <button type="button" class="btn btn-default" onclick="verifyInvoice();"  style="font-size: 20px;font-weight: bold;">نعم</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="_1_0_0_0_2_Electronic_Invoice_Query_revision.js"></script>
