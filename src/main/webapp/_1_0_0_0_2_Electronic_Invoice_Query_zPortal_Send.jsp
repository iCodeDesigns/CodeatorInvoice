                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_right">
                                <h3 style="font-weight: bold;">ارسال الفواتير</h3>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        ...
                        <div class="x_panel" style="box-shadow: -1px 2px 5px 1px #929292;">
                            <!-- for Edit -->
                            <div class="row" style="color: #327ab7;">ارسال الفواتير</div> 
                            <div class="row" style="font-size: 20px;">
                                <table>
                                    <tr>
                                        <td>الإتصال بموقع مصلحة الضرائب</td>
                                        <td>: <span id="taxStatus" class="fa fa-chain" style="color: red;"> متصل</span></td>
                                    </tr>
                                    <tr>
                                        <td>الإتصال ببرنامج التوقيع الألكتروني</td>
                                        <td>: <span id="signAppStatus" class="fa fa-chain-broken"> متصل</span></td>
                                    </tr>
                                    <tr>
                                        <td>إتصال فلاشة التوقيع الألكتروني</td>
                                        <td>: <span id="tokenStatus"> متصل</span></td>
                                    </tr>
                                </table>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                                <button type="button" data-placement="top" onclick="sendPortal();" id="portal_send_btn" disabled="" class=" button_styleSuccess btn btn-sm btn-success button_position fixedPosition fa fa-send" style="box-shadow: -1px 2px 5px 1px black;font-weight: bold;font-size: 38px;width: auto;display: block;" title="إرسال للضرائب" data-toggle="tooltip"></button>
                                ...
                                <div class="chosen-select-single mg-b-20 table-responsive" id='TaxAbleTable'>
                                    ...
                                    <table class="table table-striped jambo_table bulk_action table-bordered" style="text-align: center;">
                                        <thead>
                                            <tr class="headings">   
                                                <th>
                                                    <input type="checkbox" id="check-all" class="flat"  title="تحديد الكل" data-toggle="tooltip">
                                                </th>
