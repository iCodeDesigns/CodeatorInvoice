...
<%
    ...
    try {
        ...
        if (key.equals("Open")) {
            ...
            List<AppSubElemSpecAuth> asesaList = new AppSubElemSpecAuth_DAO().getEmpSubTabElementsSpecAuthInSubTab("" + employee_session.getEmployeeId(), "_1_0_0_0_3_Electronic_Invoice_Query_01_From_zPortal_AccessServlet");
...
<html lang="en">
    <head>
        ...
        <title>استعلام عن الفواتير من مصلحة الضرائب</title>
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_right">
                                <h3 style="font-weight: bold;">استعلام عن الفواتير من مصلحة الضرائب</h3>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        ...
                        <div class="x_panel" style="box-shadow: -1px 2px 5px 1px #929292;">
                            <!-- for Edit -->
                            <div class="row" style="color: #327ab7;">استعلام عن الفواتير من مصلحة الضرائب</div> 
    ...
    <script src="_1_0_0_0_3_Electronic_Invoice_Query_01_From_zPortal.js"></script>
