...
<html lang="en">
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_right">
                                <h3 style="font-weight: bold;">استعلام عن حالة الفواتير لدى مصلحة الضرائب</h3>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        <!--card Start -->
                        <div class="x_panel" style="box-shadow: -1px 2px 5px 1px #929292;">
                            <!-- for Edit -->
                            <div class="row" style="color: #327ab7;">استعلام عن حالة الفواتير لدى مصلحة الضرائب</div>   
                            <div class="row" >
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                                    <label class="control-label" style="font-size: 15px;">Portal Type</label>
                                    <select onchange="getChange();" name="portal_type" id="portal_type" class="form-control" tabindex="-1" required="">
                                        <option class="font-style" value="pre-production">pre-production</option>
                                        <option class="font-style" value="production">production</option>
                                    </select>
                                </div>
                                <div class="col-lg-1 col-md-1 col-sm-6 col-xs-6" style="float: left;direction: ltr;">
                                    <label class="control-label" style="font-size: 15px;">Results :</label>
                                    <select onchange="getChange();" name="records" id="records" class="form-control" tabindex="-1" required="">
                                        <option class="font-style" value="10">10</option>
                                        <option class="font-style" value="20">20</option>
                                        <option class="font-style" value="50">50</option>
                                        <option class="font-style" value="100">100</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" style="margin: 20px 0;">
                                    Results : <span id="ResultsDown">5</span>
                                </div>
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8" id="pagingDiv">
                                    <div class="paging" id="numberingPaging" style="float: left;direction: ltr;">
                                        <button onclick="getFromPortal(10, 1);" class="btn">&laquo;</button>
                                        <button onclick="getFromPortal(10, 1);" class="btn activate">1</button>
                                        <button onclick="getFromPortal(10, 2);" class="btn">2</button>
                                        <button onclick="getFromPortal(10, 3);" class="btn">3</button>
                                        <button onclick="getFromPortal(10, 4);" class="btn">4</button>
                                        <button onclick="getFromPortal(10, 5);" class="btn">5</button>
                                        <button onclick="getFromPortal(10, 6);" class="btn">6</button>
                                        <button onclick="getFromPortal(10, 6);" class="btn">&raquo;</button>
                                    </div>
                                </div>
                            </div>  
                            <!-- /for Edit -->
                ...
                <div class="modal-dialog modal-lg" style="width: 80%;">
                    <div class="modal-content">
                        ...
                        <div class="modal-header" style="background-color: #131e33;color: white;direction: rtl;">
                            ...
                            <h4 class="modal-title" id="myModalLabel2" style="font-size: 30px;">تفاصيل الفاتورة رقم: <span id="invoiceID"></span></h4>
                        </div>
                        <div class="modal-body" >
                            <div id="ErrorsDiv" style="direction: rtl;font-size: 30px;">
                                <div class="btn-danger" >
                                    أخطاء الفاتورة
                                    <div id="errors_counter" style="direction: ltr; font-size: 20px;">
                                        <!--<ol>                                           
                                            <li> step 3 00
                                                <ul>                                           
                                                    <li>x</li>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="LoadingCard">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="DataCard">
                                                ...
                                                <tbody id="Electronic_Invoice_Query_Master_Table"> 
                                                    <tr>                                                                            
                                                        <th>
                                                            ...
                                                            <input type="text" class="form-control container" id="receivername" readonly="">
                                                        </th>
                                                        <td>
                                                            <label class="control-label" style="font-size: 15px;">National ID / Registration Number</label>                                                                   
                                                            <input type="text" class="form-control container" id="receiverId" readonly="">
                                                        </td>
                                                        <td>
                                                            <label class="control-label" style="font-size: 15px;">Type</label>                                                                   
                                                            <input type="text" class="form-control container" id="receiverType" readonly="">
                                                        </td>
                                                    </tr>
                                                    <tr>                                                                            
                                                        <td colspan="3">
                                                            <label class="control-label" style="font-size: 15px;">Address</label>                                                                   
                                                            <textarea type="text" class="form-control container" id="receiverAddress" style="height: 100px;" readonly=""></textarea>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            ...
                                            <table id="MyTable" class="table table-striped table-bordered" style="text-align: center;">
                                                ...
                                                <tbody id="Electronic_Invoice_Query_Master_Table"> 
                                                    <tr>                                                                            
                                                        <th>
                                                            <label class="control-label" style="font-size: 15px;">Name</label>                                                                   
                                                            <input type="text" class="form-control container" id="issuerName" readonly="">
                                                        </th>
                                                        <td>
                                                            <label class="control-label" style="font-size: 15px;">Registration Number</label>                                                                   
                                                            <input type="text" class="form-control container" id="issuerId" readonly="">
                                                        </td>
                                                        <td>
                                                            <label class="control-label" style="font-size: 15px;">Type</label>                                                                   
                                                            <input type="text" class="form-control container" id="issuerType" readonly="">
                                                        </td>
                                                    </tr>
                                                    <tr>                                                                            
                                                        <td colspan="2">
                                                            <label class="control-label" style="font-size: 15px;">Address</label>                                                                   
                                                            <textarea type="text" class="form-control container" id="issuerAddress" style="height: 120px;" readonly=""></textarea>
                                                        </td>
                                                        <td>
                                                            <label class="control-label" style="font-size: 15px;">Tax Activity Code</label>                                                                   
                                                            <input type="text" class="form-control container" id="issuerActivityCode" readonly="">
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="chosen-select-single mg-b-20 table-responsive" id='TaxAbleTable' style="direction: rtl;">
                                            <br>
                                            <table class="table table-striped table-bordered table-hover" style="text-align: center;">
                                                <thead>
                                                    <tr style="background-color: #131e33;color: white;">   
    ...
    <script src="_1_0_0_0_4_Electronic_Invoice_Invoice_Status_InTax.js"></script>
