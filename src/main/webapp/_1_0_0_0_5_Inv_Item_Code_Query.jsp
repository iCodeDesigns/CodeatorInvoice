...
<html lang="en">
    <head>
        ...
        <title>استعلام عن الاصناف</title>
    ...
    <body class="nav-md" onload="TodayName();" style="color: #000000;" >
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_right">
                                <h3 style="font-weight: bold;">استعلام عن الاصناف</h3>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        <!--card Start -->
                        <div class="x_panel" style="box-shadow: -1px 2px 5px 1px #929292;">
                            <!-- for Edit -->
                            <div class="row" style="color: #327ab7;">استعلام عن الاصناف</div><br>
                            <div class="row">                            
                                <style>
                                    #dashTableSearch {
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" id="TableSearchDiv">
                                    ...
                                    <table id="ItemaTable" class="table table-striped table-bordered table-hover" style="text-align: center;">
                                        <thead>
                                            <tr style="background-color: #337ab7;color: white;">                                                                            
                                                ...
                                                <th style="text-align: center;"><a href='#' style='color: white;' class='sortIcon fa fa-sort' onclick='sortTable(2)'></a> كود الصنف </th>                                                
                                                <th style="text-align: center;"><a href='#' style='color: white;' class='sortIcon fa fa-sort' onclick='sortTable(3)'></a> نوع التكويد </th> 
                                                <th style="text-align: center;"><a href='#' style='color: white;' class='sortIcon fa fa-sort' onclick='sortTable(4)'></a> توصيف الصنف </th>
                                            </tr>
                                        </thead>
                                        <tbody id="Inv_Item_Code_Query_Table"> 
        ...
        <script src="_1_0_0_0_5_Inv_Item_Code_Query.js"></script>
    </body>
</html>
<%                        } else {
