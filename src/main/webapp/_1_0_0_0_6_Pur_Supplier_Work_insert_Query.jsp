...
<html lang="en">
    ...
    <body class="nav-md" onload="TodayName();" style="color: #000000;" >
        <div class="container body">
                        ...
                        <div class="x_panel" style="box-shadow: -1px 2px 5px 1px #929292;">
                            ...
                            <div class="row" >
                                <div class="chosen-select-single mg-b-20 table-responsive" id='TaxAbleTable'>
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12" style="direction: ltr;">
                                        <label class="control-label" style="font-size: 15px;">إضافة عميل</label>
                                        <div class="input-prepend input-group" >
                                            <button type="button" data-toggle="modal" data-target=".addSupplier" class="fa fa-plus btn btn-success" style="font-size: large;border: 2px solid white;"></button>
                                        </div>
                                    </div>
                                    <br>                                    
                                    <table id="MyTable" class="table table-striped table-bordered" style="text-align: center;">
                                        <thead>
                                            <tr style="background-color: #337ab7;color: white;">                                                                            
                                                <th style="text-align: center;">كود العميل</th>
                                                <th style="text-align: center;">جنسية العميل</th>
                                                <th style="text-align: center;">رقم المتعامل</th>
                                                <th style="text-align: center;">اسم المتعامل</th>
                                                <th style="text-align: center;">المحافظة</th>
                                                <th style="text-align: center;">الشارع</th>
                                                <th style="text-align: center;">رقم المبنى</th>
                                            </tr>
                                        </thead>
                ...
                <div class="modal-dialog modal-lg" style="width: 80%;">
                    <div class="modal-content">
                        ...
                        <div class="modal-header" style="background-color: #131e33;color: white;direction: rtl;">
                            ...
                            <h4 class="modal-title" id="myModalLabel2" style="font-size: 30px;">إضافة عميل<span id="invoiceID"></span></h4>
                        </div>
                        <div class="modal-body" >
                            <div class="row" style="direction: rtl;">     
                                <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4">
                                    <label class="control-label" style="font-size: 15px;">الدولة<span class="required">*</span></label>                                                                   
                                    <select data-placeholder="Choose a Country..." onchange="suppType();getGov('countryCode_govCode', 'countryCode');" name="countryCode" id="countryCode" class="form-control" tabindex="-1" required="">
                                        <%
                                            List<PerCountryCode> PerCountryCodeList = new PerCountryCodeDAO().GetAllCountriesIncludeEG();
                                            for (PerCountryCode p : PerCountryCodeList) {
                                                String selected = "";
                                                if (p.getCountryCode().equals("1")) {
                                                    selected = " selected ";
                                                } else {
                                                    selected = "";
                                                }
                                        %>
                                        <option class="font-style" <%=selected%> value="<%=p.getCountryCode()%>"><%=p.getACountryName()%></option>
                                        <%                                            //
                                            }
                                        %>
                                    </select>
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4">
                                    ...
                                    <select data-placeholder="Choose a Country..." name="countryCode_govCode" id="countryCode_govCode" class="form-control" tabindex="-1" required="">
                                        <%
                                            List<PerGovernorateCode> PerGovernorateCodeList = new PerGovernorateCodeDAO().GetPerGovernorateCodeByCountry("1");
                                            for (PerGovernorateCode p : PerGovernorateCodeList) {

                                        %>
                                        <option class="font-style" value="<%=p.getId().getCountryCode()%>-<%=p.getId().getGovCode()%>"><%=p.getAGovName()%></option>
                                        <%                                            //
                                            }
                                        %>
                                    </select>
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4">
                                    <label class="control-label" style="font-size: 15px;">اسم العميل<span class="required">*</span></label>                                                                   
                                    <input type="text" class="form-control" name="supplierName" id="supplierName" required="">
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4" id="passportDiv">
                                    <label class="control-label" style="font-size: 15px;">رقم جواز السفر<span class="required">*</span></label>                                                                   
                                    <input type="text" class="form-control" name="passport" id="passport" required="">
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4"  id="taxCardNoDiv">
                                    <label class="control-label" style="font-size: 15px;">البطاقة الضريبية<span class="required">*</span></label>                                                                   
                                    <input type="text" class="form-control" onkeyup="allNumeric('taxCardNo');" name="taxCardNo" id="taxCardNo" required="">
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4"  id="identNoDiv">
                                    <label class="control-label" style="font-size: 15px;">الرقم القومي<span class="required">*</span></label>                                                                   
                                    <input type="text" class="form-control" onkeyup="allNumeric('identNo');" name="identNo" id="identNo" required="">
                                </div>
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4">
                                    ...
                                    <input type="text" class="form-control" name="buildingNumber" id="buildingNumber" required="" maxlength="9">
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <button type="button" onclick="addSupplier();" class="fa fa-plus btn btn-primary" style="font-size: large;border: 2px solid white;width: 100%"> حفظ</button>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal fade supplierDetails" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-lg" style="width: 80%;">
                    <div class="modal-content">
                        ...
                        <div class="modal-header" style="background-color: #131e33;color: white;direction: rtl;">
                            ...
                            <h4 class="modal-title" id="myModalLabel2" style="font-size: 30px;">تعديل عميل<span id="invoiceID"></span></h4>
                        </div>
                        <div class="modal-body" >
                            <div class="row" style="direction: rtl;">                                 
                                <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4">
                                    <label class="control-label" style="font-size: 15px;">الدولة<span class="required">*</span></label>                                                                   
                                    <select data-placeholder="Choose a Country..." onchange="suppType2();getGov('countryCode_govCode_edit', 'countryCode_edit');"  name="countryCode_edit" id="countryCode_edit" class="form-control" tabindex="-1" required="">
                                        <%
                                            PerCountryCodeList = new PerCountryCodeDAO().GetAllCountriesIncludeEG();
                                            for (PerCountryCode p : PerCountryCodeList) {
                                                String selected = "";
                                                if (p.getCountryCode().equals("1")) {
                                                    selected = " selected ";
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4">
                                    <label class="control-label" style="font-size: 15px;">المحافظة<span class="required">*</span></label>                                                                   
                                    <select data-placeholder="Choose a Country..." name="countryCode_govCode_edit" id="countryCode_govCode_edit" class="form-control" tabindex="-1" required="">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4">
                                    <label class="control-label" style="font-size: 15px;">اسم العميل<span class="required">*</span></label>                                                                   
                                    <input type="text" class="form-control" name="supplierName_edit" id="supplierName_edit" required="">
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4" id="passport_editDiv">
                                    <label class="control-label" style="font-size: 15px;">رقم جواز السفر<span class="required">*</span></label>                                                                   
                                    <input type="text" class="form-control" name="passport_edit" id="passport_edit" required="">
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4" id="taxCardNo_editDiv">
                                    <label class="control-label" style="font-size: 15px;">البطاقة الضريبية<span class="required">*</span></label>                                                                   
                                    <input type="text" class="form-control" onkeyup="allNumeric('taxCardNo_edit');" name="taxCardNo_edit" id="taxCardNo_edit" required="">
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4" id="identNo_editDiv">
                                    <label class="control-label" style="font-size: 15px;">الرقم القومي<span class="required">*</span></label>                                                                   
                                    <input type="text" class="form-control" onkeyup="allNumeric('identNo_edit');"  name="identNo_edit" id="identNo_edit" required="">
                                </div>

                                <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4">
                                    <label class="control-label" style="font-size: 15px;">الشارع<span class="required">*</span></label>                                                                   
                                    <input type="text" class="form-control" name="street_edit" id="street_edit" required="">
                                </div>
                                <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4">
                                    <label class="control-label" style="font-size: 15px;">رقم المبني<span class="required">*</span></label>                                                                   
                                    <input type="text" class="form-control" name="buildingNumber_edit" id="buildingNumber_edit" required="" maxlength="9">
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <button type="button" onclick="editSupplier();" class="fa fa-save btn btn-primary" style="font-size: large;border: 2px solid white;width: 100%"> تعديل</button>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer" style="background-color: #131e33;">
    ...
    <script src="_1_0_0_0_6_Pur_Supplier_Work_insert_Query.js"></script>
