...
<html lang="en">
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_right">
                                <h3 style="font-weight: bold;">إحصائيات الفاتورة الاكترونية لادارة</h3>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        <!--card Start -->
                        <div class="row">
                            <div class="">
                                <div class="x_panel card_options" style="box-shadow: -1px 2px 5px 1px #929292;">
                                    <!-- for Edit -->
                                    <div class="x_title">
                                        <h2 style="width: 50%;font-weight: bold;float: right;color: #000000;">فلتر</h2>
                                        ...
                                        <div class="row" >
                                            <div class="chosen-select-single mg-b-20 table-responsive" id='TaxAbleTable'>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-6 col-xs-6">
                                                    <label class="control-label" style="font-size: 15px;">حالة المستند</label>                                        
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-6 col-xs-6">
                                                    ...
                                                    <select onchange="changeFilter();" id="searchType" class="form-control" tabindex="-1"  style="border: black solid 2px;">                                                        
                                                        <option value="d" selected>فترة</option>
                                                        <option value="y" >سنوي</option>
                                                    </select>
                                                </div>

                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="FromDiv">
                                                    <label class="control-label" style="font-size: 15px;">من تاريخ</label>
                                                    <input type="date" value="<%=new DateOp().getCustomSysDate("yyyy-MM-dd")%>" name="dateFrom" id="dateFrom" class="form-control" style="border: black solid 2px;">
                                                </div>

                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="ToDiv" >
                                                    <label class="control-label" style="font-size: 15px;">إلى تاريخ</label>
                                                    <input type="date" value="<%=new DateOp().getCustomSysDate("yyyy-MM-dd")%>" name="dateTo" id="dateTo" class="form-control" style="border: black solid 2px;">
                                                </div>

                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="yearDiv">
                                                    <label class="control-label" style="font-size: 15px;">السنة</label>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <label class="control-label" style="font-size: 15px;">نوع بحث القيم</label>
                                                    <select onchange="" id="values_search" class="form-control" tabindex="-1"  style="border: black solid 2px;">                                                        
                                                        <option value="counter">احصائية أعداد الفواتير</option>
                                                        <option value="money">احصائية إجماليات مالية الفواتير</option>
                                                    </select>
                                                </div>
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <br>
                                                    <button type="button" data-placement="top" onclick="getInvoiceCountNumbers();" class="btn btn-sm btn-primary fa fa-search" style="box-shadow: -1px 2px 5px 1px black;font-weight: bold;font-size: 38px;width: auto;display: block;"> بحث</button>
                                                </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel" style="box-shadow: -1px 2px 5px 1px #929292;">
                                    <!-- for Edit -->
                                    <div class="x_title">
                                        <h2 style="width: 50%;font-weight: bold;float: right;color: #327ab7;">إحصائية أعداد الفواتير</h2>
                                        <div class="clearfix"></div>
                                    </div>
    ...
    <script src="_1_0_0_0_7_Electronic_Invoice_Dept_Charts_1.js"></script>
