...
<%@page import="com.codeator.www._1_3_DB_daos.PurSuppWorkDao"%>
<%@page import="com.codeator.www._1_2_DB_entities.PurSuppWork"%>
                ...
                <div class="right_col" role="main"> 
                    ...
                    <div class="">
                        ...
                        <div class="x_panel" style="box-shadow: -1px 2px 5px 1px #929292;">
                            <!-- for Edit -->
                            <div class="row" style="color: #327ab7;">إضافة أقسام</div>                               
                            <div class="row">

                            </div>
                            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <label class="control-label" style="font-size: 15px;">الشركة<span class="required">*</span></label>                                                                   
                                    <select style="width: 100%;" data-placeholder="Choose a Country..." name="SuppSeq" id="SuppSeq" class="form-control SELECT_Combo" tabindex="-1" required="">
                                        <%
                                            List<PurSuppWork> PurSuppWorkList = new PurSuppWorkDao().GetAllPurSupplierWork();
                                            String Ident = "";
                                            for (PurSuppWork p : PurSuppWorkList) {
                                                String TaxCardNo = p.getTaxCardNo();
                                                String IndentNo = p.getIdentNo();
                                                if (p.getSuppName().length() >= 10) {
                                                if (TaxCardNo != null && TaxCardNo.length() >= 9) {
                                                    Ident = TaxCardNo.replaceAll("[-/]", "");
                                                } else if (IndentNo != null && IndentNo.length() >= 14 && TaxCardNo == null) {
                                                    Ident = IndentNo;
                                                }

                                        %>
                                        <option class="font-style" value="<%=p.getSuppSeq()%>"><%=p.getSuppName()%>-<%=Ident%></option>
                                        <%   //
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <label class="control-label" style="font-size: 15px;">اسم الفرع او القسم<span class="required">*</span></label>                                                                   
                                    <input type="text" class="form-control" name="suppNameBr" id="suppNameBr" required="">
                                </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <label class="control-label" style="font-size: 15px;">العنوان ان كان فرع خارج مقر الشركة</label>                                                                   
                                    <input type="text" class="form-control" name="AddressBr" id="AddressBr" required="">
                                </div>
                                
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <label class="control-label" style="font-size: 15px;">كود العميل الخاص بالمين فريم<span class="required" style="color: black;">(اختياري)</span></label>                                                                   
                                    <input type="text" class="form-control" name="suppMainFrameCode" id="suppMainFrameCode" required="">
                                </div>
                                <!--<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <label class="control-label" style="font-size: 15px;">كود المنتج<span class="required" style="color: black;">(اختياري)</span></label>                                                                   
                                    <input type="text" class="form-control" name="advProducerCode" id="advProducerCode" required="">
                                </div>  
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <label class="control-label" style="font-size: 15px;">كود المحصل<span class="required" style="color: black;">(اختياري)</span></label>                                                                   
                                    <input type="text" class="form-control" name="advCollectorCode" id="advCollectorCode" required="">
                                </div>  -->
                            </div><br>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" >
                                    <button type="button" data-toggle="modal" onclick="addSupplierDtl();" class="fa fa-save btn btn-success" style="font-size: large;border: 2px solid white;width: 100%;"> حفظ</button>
                                </div>
                            </div>
                    ...
                    <div class="x_panel" style="box-shadow: -1px 2px 5px 1px #929292;">
                        <!-- for Edit -->
                        <div class="row" style="color: #327ab7;">بيانات الأقسام</div>                               
                        <div class="row">
                            ...
                            <div class="chosen-select-single mg-b-20 table-responsive" id='TaxAbleTable'>
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    ...
                                    <div class="input-prepend input-group" style="border: black solid 2px;">
                                        <input type="text" autocomplete="no" name="TableSearch" id="TableSearch" style="width: 100%;" onkeyup="TableSearch();" class="form-control">
                                        <span class="input-group-addon searchCustom" style="border: 1px solid #e5e6e7;"><i class="fa fa-search"></i></span>
                                    </div>
                                </div>                                
                                <br>                                    
                                <table id="supplierDataTable" class="table table-striped table-bordered table-hover" style="text-align: center;">
                                    <thead>
                                        <tr style="background-color: #337ab7;color: white;">                                                                            
                                            ...
                                            <th style="text-align: center;">كود العميل الخاص بالمين فريم</th>
...
<script src="_1_0_0_0_8_Pur_Supplier_Work_Dtl_insert_Query.js"></script>
