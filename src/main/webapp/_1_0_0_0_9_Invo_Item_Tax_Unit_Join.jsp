                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_right">
                                <h3 style="font-weight: bold;">بيانات مصلحة الضرائب الأساسية</h3>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        <!--card Start -->
                        <div class="col-lg-12 col-md-12 col-sm-6 col-xs-6">
                            <div class="x_panel" style="box-shadow: -1px 2px 5px 1px #929292;">
                                <div class="x_title">
                                    <h2 style="width: 50%;font-weight: bold;float: right;color: #327ab7;">بيانات الضرائب بالإدارة</h2>
                                ...
                                <div class="x_content" style="display: none;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-1 col-md-1 col-sm-2 col-xs-2 form-group" id="swap_btn">                                            
                                            <button type="button" data-placement="top" onclick="saveTaxs();" class="button_style btn btn-sm btn-primary" data-original-title="تبديل نظام البحث" data-toggle="tooltip" data-placement="bottom" style="font-weight: bold;font-size: 15px;padding-bottom: 6px;padding-top: 6px;margin-top: 26px;" data-toggle="modal" data-target="#x"><i class="fa fa-save"> حفظ</i></button>
                                        </div>                                                                        
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-6 col-xs-6">
                            <div class="x_panel" style="box-shadow: -1px 2px 5px 1px #929292;">
                                <div class="x_title">
                                    <h2 style="width: 50%;font-weight: bold;float: right;color: #327ab7;">بيانات وحدات القياس بالإدارة</h2>
                                ...
                                <div class="x_content" style="display: none;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-1 col-md-1 col-sm-2 col-xs-2 form-group" id="swap_btn">                                            
                                            <button type="button" data-placement="top" onclick="saveUnits();" class="button_style btn btn-sm btn-primary" data-original-title="تبديل نظام البحث" data-toggle="tooltip" data-placement="bottom" style="font-weight: bold;font-size: 15px;padding-bottom: 6px;padding-top: 6px;margin-top: 26px;" data-toggle="modal" data-target="#x"><i class="fa fa-save"> حفظ</i></button>
                                        </div>    
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-6 col-xs-6">
                            <div class="x_panel" style="box-shadow: -1px 2px 5px 1px #929292;">
                                <div class="x_title">
                                    <h2 style="width: 50%;font-weight: bold;float: right;color: #327ab7;">بيانات توصيف الأصناف بالإدارة</h2>
                                    <ul class="nav navbar-left panel_toolbox" style="direction: ltr;float: left;width: 50%;" onclick="">
                                ...
                                <div class="x_content">
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                                            <label class="control-label" style="font-size: 15px;">الأصناف</label>                                                                   
                                            <select style="width: 100%;" data-placeholder="أختر صنف..." name="itemCode" id="itemCode" class="form-control SELECT_Combo" tabindex="-1" required="">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                                            <label class="control-label" style="font-size: 15px;">توصيف الصنف بالعربية</label>                                                                   
                                            <input type="text" class="form-control" name="aItemDesc" id="aItemDesc" required="">
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                                            <label class="control-label" style="font-size: 15px;">توصيف الصنف بالانجليزية</label>                                                                   
                                            <input type="text" class="form-control" name="eItemDesc" id="eItemDesc" required="">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                                            <label class="control-label" style="font-size: 15px;">باركود الصنف ان وجد</label>                                                                   
                                            <input type="text" class="form-control" name="itemBarcode" id="itemBarcode" required="">
                                        </div>                                
                                    </div>
                                    <div class="col-lg-1 col-md-1 col-sm-2 col-xs-2 form-group" id="swap_btn">                                            
                                        <button type="button" data-placement="top" onclick="addItemDtl();" class="button_style btn btn-sm btn-primary" data-original-title="تبديل نظام البحث" data-toggle="tooltip" data-placement="bottom" style="font-weight: bold;font-size: 15px;padding-bottom: 6px;padding-top: 6px;margin-top: 26px;" data-toggle="modal" data-target="#x"><i class="fa fa-save"> حفظ</i></button>
                                    </div> 
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-6 col-xs-6">
                                            <div class="chosen-select-single mg-b-20 table-responsive">
                                                ...
                                                <table class="table table-striped jambo_table bulk_action table-bordered" style="text-align: center;">                                                    
                                                    <thead>
                                                        <tr style="background-color: #337ab7;color: white;">                                                                            
                                                            ...
                                                            <th style="text-align: center;">توصيف الصنف بالعربية</th>
                                                            <th style="text-align: center;">توصيف الصنف بالانجليزية</th>
                                                            <th style="text-align: center;">باركود الصنف</th>
