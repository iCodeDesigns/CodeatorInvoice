    ...
    try {
        ...
        if (key.equals("Open")) {
            ...
            for (AppSubElemSpecAuth a : asesaList) {
                if (a.getAppSubElem().getElementName().equals("LogBtn")) {
                    LogBtnStatus = true;
                    break;
                }
            }
...
<html lang="en">
    ...
    <body class="nav-md" onload="TodayName();" style="color: #000000;" >
        <div class="container body">
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_right">
                                <h3 style="font-weight: bold;">طباعة الفواتير</h3>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        ...
                        <div class="x_panel" style="box-shadow: -1px 2px 5px 1px #929292;">
                            <!-- for Edit -->
                            <div class="row" style="color: #327ab7;">طباعة الفواتير</div>                            
                            <div class="row" >

                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                                    <label class="control-label" style="font-size: 15px;">نوع البحث</label>
                                    <select data-placeholder="Choose a Country..." onchange="document.getElementById('internalId').value = '';checkSearch();getInvoiceMaster();" id="searchType" class="form-control" tabindex="-1" required="">                                        
                                        <option class="font-style" selected="" value="internalId">رقم الفاتورة الداخلي</option>
                                        <option class="font-style" value="paidFormCode">كود التحصيل</option>
                                        <%
                                            if (RecieveDevliverCodeStstus) {
                                        %>
                                        <option class="font-style" value="permToReceiveCode">كود التسليم</option>
                                        <option class="font-style" value="permToDeliverCode">كود الصرف</option>
                                        <%
                                            }
                                        %>
                                        <option class="font-style" value="bulk">بحث بالك</option>
                                    </select>
                                </div>

                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6" id='internalIdField'>
                                    <label class="control-label" style="font-size: 15px;">البحث</label>
                                    <input type="text" class="form-control" onkeyup="getInvoiceMaster();" name="internalId" id="internalId">
                                </div>

                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12" id='fromDateField' >
                                    <label class="control-label" style="font-size: 15px;">من تاريخ</label>                                                                   
                                    <input type="date" class="form-control" name="fromDate" id="fromDate" required="">
                                </div>                                

                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12" id='toDateField'  >
                                    <label class="control-label" style="font-size: 15px;">إلى تاريخ</label>                                                                   
                                    <input type="date" class="form-control" name="toDate" id="toDate" required="">
                                </div>

                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12" id='createdDate_OR_issueDateField' >
                                    <label class="control-label" style="font-size: 15px;">نوع التاريخ المستخدم</label>                                                                   
                                    <select class="form-control" name="createdDate_OR_issueDate" id="createdDate_OR_issueDate" required="">
                                ...
                                <button type="button" id='searchBTNForDate' class="fa fa-search btn btn-primary" onclick="getInvoiceMaster();" style="font-size: large;border: 2px solid white;" > بحث</button>
                                        ...
                                        <table class="table table-striped table-bordered" style="text-align: center;">
                                            <thead>
                                                <tr style="background-color: #337ab7;color: white;">                                                                            
                                                    ...
                                                    <th style="text-align: center;">كود التحصيل</th>
                                                        <%
                                                            if (RecieveDevliverCodeStstus) {
                                                        %>
                                                    <th style="text-align: center;">كود التسليم</th>
                                                    <th style="text-align: center;">كود الصرف</th>
                                                    <th style="text-align: center;">تاريخ التسليم والصرف</th>
                                                        <%
                                                            }
                                                        %>
            ...
            <div class="modal fade InvoiceDetailsLog" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-lg" style="width: 90%;">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="direction: rtl;">                            
                            <div class="row" >
                                <div class="chosen-select-single mg-b-20 table-responsive" id=''>
                                    <label></label>
                                    <table class="table table-striped table-bordered table-hover" style="text-align: center;">
                                        <thead>
                                            <tr style="background-color: #337ab7;color: white;">   
                                                ...
                                                <th style="text-align: center;">رقم التأمين</th>
                                                <th style="text-align: center;">اسم المستخدم</th>                                           
                                            </tr>
                                        </thead>
                                        <tbody id="Invoice_Log"> 
            ...
            <!-- /page content -->
            <div class="button_styleSuccess" style="background-color: #ffffff00;display: none;" id="printBulkDiv">
                <button type="button" data-placement="top" onclick="printPageBulk('ar');" id="submitDocument" class="  btn btn-sm btn-success button_position fixedPosition fa fa-print" style="box-shadow: -1px 2px 5px 1px black;font-weight: bold;font-size: 38px;width: auto;display: block;float: left;" data-toggle="tooltip"> طباعة بالأرقام العربية</button>
                <button type="button" data-placement="top" onclick="printPageBulk('en');" id="submitDocument" class="  btn btn-sm btn-success button_position fixedPosition fa fa-print" style="box-shadow: -1px 2px 5px 1px black;font-weight: bold;font-size: 38px;width: auto;display: block;" data-toggle="tooltip"> طباعة بالأرقام الإنجليزية</button>
            </div>
    ...
    <script>
                    ...
                    sleep(2000);
                    var LogBtnStatus = <%=LogBtnStatus%>;

                    var RecieveDevliverCodeStstus = <%=RecieveDevliverCodeStstus%>;
    </script>

    <script src="_1_0_0_1_0_Electronic_Invoice_Query.js"></script>
