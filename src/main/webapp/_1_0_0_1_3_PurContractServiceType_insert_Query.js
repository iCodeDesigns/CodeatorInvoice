...
function addService() {
    ...
    $.ajax({
        url: "_1_0_0_1_3_PurContractServiceType_insert_Query_Ajax_2_addService_AjaxServlet?"
...
function updateService(serviceSeq) {
    ...
    $.ajax({
        url: "_1_0_0_1_3_PurContractServiceType_insert_Query_Ajax_3_updateService_AjaxServlet?"
...
function deleteService(serviceSeq) {
    ...
    $.ajax({
        url: "_1_0_0_1_3_PurContractServiceType_insert_Query_Ajax_4_deleteService_AjaxServlet?"
