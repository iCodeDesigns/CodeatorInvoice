...
<html lang="en">
    <head>
        ...
        <title>شاشة تقرير الفواتير</title>
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_right">
                                <h3 style="font-weight: bold;">تقرير الفواتير</h3>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        <!--card Start -->
                        <div class="x_panel" style="box-shadow: -1px 2px 5px 1px #929292;">
                            ...
                            <div class="row" >
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="chosen-select-single">
                                        <label class="control-label" style="font-size: 15px;">اختر اعمدة التقرير</label> 
                                        <style>
                                        ...
                                        <select data-placeholder="اختر أعمدة التقرير..." style="direction: rtl;" class="chosen-select" name="DocStatus" id="DocStatus" multiple="" tabindex="-1">
                                            <%
                            ...
                            <div class="row" >
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6"  id="taxCardNoDiv">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-6 col-xs-6">
                                    <br>
                                    <button type="button" onclick="search_counts();" class="form-control fa fa-search-plus btn btn-primary" style="font-size: large;border: 2px solid white;width: 100%"> بحث</button>
                                </div>
                            </div>
                            <!-- /for Edit -->
                        </div>
                        ...
                        <div class="x_panel" style="box-shadow: -1px 2px 5px 1px #929292;">
                            <!-- for Edit -->
                            <div class="row" style="color: #327ab7;">عرض التقرير</div>                               
                            <div class="row">
    ...
    <script src="_1_0_0_1_4_Electronic_Invoice_Count_Report.js"></script>
