...
getTaxTypeDtl();
function getTaxTypeDtl() {
    var taxable = $("#taxable").val();
    document.getElementById("taxTypeDtl").innerHTML = "";
    $(".chosen-select").trigger("chosen:updated");
    $.ajax({
        url: "_1_0_0_1_5_Electronic_Invoice_Count_Tax_Report_OnDept_03_getTaxTypeDtl_AjaxServlet?taxable=" + taxable,
        type: 'POST',
        //dataType: 'json',
        ...
        success: function (data) {
            ...
            for (var i = 0; i < data.length; i++) {
                html += "<option value='" + data[i].id.taxType + "," + data[i].id.taxSubtype + "'>" + data[i].ataxSubname + "</option>";
            }
            document.getElementById("taxTypeDtl").innerHTML = html;
            $(".chosen-select").trigger("chosen:updated");
        },
...
function search() {
    ...
    var taxTypeDtl = document.getElementById("taxTypeDtl").value;
    var fromDate = document.getElementById("fromDate").value;
    var toDate = document.getElementById("toDate").value;
    if (taxTypeDtl === null || taxTypeDtl === "") {
        Warning("اختر حالة المستند المراد الاستعلام عنها");
...
function searchDtl() {
    ...
    document.getElementById("Electronic_Invoice_Query_Master_Table").innerHTML =
            ...
            + "</tr>";
    $.ajax({
        url: "_1_0_0_1_5_Electronic_Invoice_Count_Report_OnDept_02_getInvoicesFromDeptsAcc_AjaxServlet?"
                + "fromDate=" + fromDate
                + "&toDate=" + toDate
