...
<html lang="en">
    <head>
        ...
        <title>تقرير إجمالي ضرائب الفواتير</title>
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_right">
                                <h3 style="font-weight: bold;">تقرير إجمالي ضرائب الفواتير</h3>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        <!--card Start -->
                            ...
                            <div class="row" >
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-4">
                                        ...
                                        <select data-placeholder="Choose a Country..." name="taxable" id="taxable" onchange="getTaxTypeDtl();" class="form-control" tabindex="-1" required="">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">                                    
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="chosen-select-single">
                                            ...
                                            <select data-placeholder="اختر نوع الضريبة..." style="direction: rtl;" class="chosen-select" name="taxTypeDtl" id="taxTypeDtl" multiple="" tabindex="-1">
                        ...
                        <div class="x_panel" style="box-shadow: -1px 2px 5px 1px #929292;" id="countsDiv">
                            <!-- for Edit -->
                            <div class="row" style="color: #327ab7;">نتيجة البحث</div>                            
                            <div class="row" >
    ...
    <script src="_1_0_0_1_5_Electronic_Invoice_Count_Tax_Report_OnDept.js"></script>
