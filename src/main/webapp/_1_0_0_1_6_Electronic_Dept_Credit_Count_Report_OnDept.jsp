...
<html lang="en">
    <head>
        ...
        <title>تقرير فواتير الاشعارات</title>
        ...
        <div class="container body">
            <div class="main_container">
                ...
                <div class="right_col" role="main"> 
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_right">
                                <h3 style="font-weight: bold;">تقرير فواتير الاشعارات</h3>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        <!--card Start -->
                                    ...
                                    <table id="dataCutomTable" class="table table-striped table-bordered" style="text-align: center;">
                                        <thead>
                                            <tr style="background-color: #41505d;color: white;">  
                                                ...
                                                <th style="text-align: center;">الإشعارات</th> 
                                            </tr>
                                        </thead>
                    ...
                    <div class="modal fade InvoiceDtlMain" tabindex="-1" role="dialog" aria-hidden="true">
                                ...
                                <div class="modal-body" style="direction: rtl;">                            
                                    <div class="row" >
                                        <div class="chosen-select-single mg-b-20 table-responsive" id=''>
                                            <label></label>
                                            <table id="dataCutomTableDtl" class="table table-striped table-bordered table-hover" style="text-align: center;">
                                                <thead>
                                                    <tr style="background-color: #41505d;color: white;">  
                                                        <th style="text-align: center;">الوحدة الحسابية</th>
                                                        <th style="text-align: center;">الإدارة</th>
                                                ...
                                                <tbody id="Electronic_Invoice_Query_Master_DTL_Table"> 
    ...
    <script src="_1_0_0_1_6_Electronic_Dept_Credit_Count_Report_OnDept.js"></script>
