...
<html lang="en">
    ...
    <body class="nav-md" onload="TodayName();" style="color: #000000;" >
                                ...
                                <div class="x_content" style="display: none;font-size: 20px;">                                    
                                        ...
                                        <table id="" class="table table-striped table-bordered table-hover">
                                            <thead style="background-color: black;color: white;">
                                                <tr>
                                                    ...
                                                    <th style="text-align: center;font-size: 15px;width: 10%">Sub Tab</th>
                                            ...
                                            <tbody style="text-align: center;">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select style="font-size: 15px;font-weight: bold;" onchange="resetSearch();LoadSubTabAjax2();" type="text" placeholder="النظام" id="applicationTabIdS_2" maxlength="45" name="applicationTabIdS_2" class="form-control" required="">                                          
                                                            <option value="">اختر القائمة ...</option>

                                                        </select>
                                                    </td>
                                                    <td>
                                                        <select style="font-size: 15px;font-weight: bold;" onchange="resetSearch();" type="text" placeholder="النظام" id="applicationSubTabIdS_2" maxlength="45" name="applicationTabIdS_2" class="form-control" required="">                                          
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <table id="" class="table table-striped table-bordered table-hover" style="text-align: center;">
                                            <thead style="background-color: black;color: white;">
                                                <tr>
                                                    <th style="text-align: center;font-size: large;">Element Code</th>
                                                    <th style="text-align: center;font-size: large;">Element Name</th>
                                                    <th style="text-align: center;font-size: large;width: 30%;">Element Availability</th>
        ...
        <script src="_9_9_9_9_9_4_Employee_ScreenElements_Auth_Distribution.js"></script>
