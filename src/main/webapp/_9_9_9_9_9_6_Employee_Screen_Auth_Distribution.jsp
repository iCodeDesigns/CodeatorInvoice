...
<html lang="en">
    ...
    <body class="nav-md" onload="TodayName();" style="color: #000000;" >
                    ...
                    <div class="">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel" style="box-shadow: -1px 2px 5px 1px #929292;">
                                ...
                                <div class="x_content" style="display: none;font-size: 20px;">                                    
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12" style="text-align: left;">
                                        ...
                                        <table id="" class="table table-striped table-bordered table-hover">
                                            <thead style="background-color: black;color: white;">
                                                <tr>
                                                    <th style="text-align: center;font-size: 15px;width: 10%">Application</th>
                                                    <th style="text-align: center;font-size: 15px;width: 10%">Tab</th>
                                                    <th style="text-align: center;font-size: 15px;width: 10%">Employee No</th>
                                                    <th style="text-align: center;font-size: 15px;width: 10%">Employee Name</th>                                                        
                                                </tr>
                                            </thead>
                                            <tbody style="text-align: center;">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select style="font-size: 15px;font-weight: bold;" onchange="resetSearch();" type="text" placeholder="النظام" id="applicationTabIdS_2" maxlength="45" name="applicationTabIdS_2" class="form-control" required="">                                          
                                                            <option value="">اختر القائمة ...</option>

                                                        </select>
                                                    </td>
                                                    <td><input onchange="resetSearch();" onkeyup="getEmpDataAjax();"  type="text" class="form-control" name="" id="searchEmpId" maxlength="6" value="" required=""></td>                                                
                                    ...
                                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                                        <table id="" class="table table-striped table-bordered table-hover" style="text-align: center;">
                                            <thead style="background-color: black;color: white;">
                                                <tr>
                                                    <th style="text-align: center;font-size: large;">Tab Code</th>
                                                    <th style="text-align: center;font-size: large;">Tab Name</th>
                                                    <th style="text-align: center;font-size: large;width: 1%;">Screen Availability</th>
                                                    <th style="text-align: center;font-size: large;">Access Type</th>
                                                </tr>
                                            </thead>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td colspan="4"><button disabled="" id="saveAuthBtn" type="button" class="fa fa-save btn btn-primary" onclick="SaveAuth();" style="font-size: 30px;font-weight: bold;border: 2px solid black;box-shadow: 7px 8px 11px black;width: 100%;"> Save</button></td>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="text-align: left;">
                                        ...
                                        <table id="" class="table table-striped table-bordered table-hover">
                                            <thead style="background-color: black;color: white;">
                                                <tr>
                                                    <th style="text-align: center;font-size: 15px;width: 10%" colspan="5">Authorized Screens</th>
                                                </tr>
                                                <tr>
                                                    <th style="text-align: center;font-size: 15px;width: 20%">Application</th>
                                                    <th style="text-align: center;font-size: 15px;width: 30%">Tab</th>
                                                    <th style="text-align: center;font-size: 15px;width: 30%">Sub Tab</th>
                                                    <th style="text-align: center;font-size: 15px;width: 20%">vendeta Auth Type</th>
                                                    <th style="text-align: center;font-size: 15px;width: 5%">Status</th>
                                                </tr>
                                            </thead>
                                            <tbody style="text-align: center;" id="EmpAuthData">
                                                <tr>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel" style="box-shadow: -1px 2px 5px 1px #929292;">
                                <div class="x_title">
                                    <h2 style="width: 50%;">Employee Authorization by All SubTabs</h2>
                                    <ul class="nav navbar-left panel_toolbox" style="direction: ltr;float: left;width: 50%;">
                                        <li><a class="collapse-link"><i class="fa fa-chevron-down"></i></a>
                                        </li>
                                    </ul>
                                ...
                                <div class="x_content" style="display: none;font-size: 20px;">                                    
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12" style="text-align: left;">
                                        ...
                                        <table id="" class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody style="text-align: center;">
                                                <tr>                                                    
                                                    <td><input onkeyup="getEmpDataAjax2();"  type="text" class="form-control" name="" id="searchEmpId2" maxlength="6" value="" required=""></td>                                                
                                                    <td id="searchEmpData2" style="text-align: right;"></td>
                                                </tr>                                        
                                            </tbody>                                                
                                        </table>
                                    </div>
                                        ...
                                        <table id="" class="table table-striped table-bordered table-hover" style="text-align: center;">
                                            <thead style="background-color: black;color: white;">                                                
                                                <tr>
                                                    ...
                                                    <th style="text-align: center;font-size: large;">Tab Name</th>
                                                    <th style="text-align: center;font-size: large;">Sub Tab Code</th>
                                                    <th style="text-align: center;font-size: large;">Sub Tab Name</th>
                                                    <th style="text-align: center;font-size: large;">Screen Availability</th>
                                                    <th style="text-align: center;font-size: large;">Access Type</th>
                                                </tr>
                                            </thead>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td colspan="6"><button disabled="" id="saveAuthBtn2" type="button" class="fa fa-save btn btn-primary" onclick="SaveAuth2();" style="font-size: 30px;font-weight: bold;border: 2px solid black;box-shadow: 7px 8px 11px black;width: 100%;"> Save</button></td>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    </div>
        ...
        <script src="_9_9_9_9_9_6_Employee_Screen_Auth_Distribution.js"></script>
