...
<html lang="en">
    ...
    <body class="nav-md" onload="TodayName();" style="color: #000000;" >
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_right">
                                <h3 style="font-weight: bold;">Menu Index Sorting</h3>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="x_panel" style="box-shadow: -1px 2px 5px 1px #929292;">
                                <div class="x_title">
                                    <h2 style="width: 50%;">Application Index Sort</h2>
                                ...
                                <div class="x_content" style="display: none;">                                    
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="text-align: left;">
                                        <!-- start skills -->
                                        <button type="button" disabled="" class="fa fa-check btn btn-success" id="SaveApplicationIndex"   onclick="SaveApplicationIndex();" style="font-size: large;font-weight: bold;border: 2px solid white;box-shadow: 7px 8px 11px black;"></button>
                                        <button type="button" disabled="" class="fa fa-close btn btn-danger"    id="cancelApplicationIndex" onclick="cancelApplicationIndex();" style="font-size: large;font-weight: bold;border: 2px solid white;box-shadow: 7px 8px 11px black;"></button>
                                        <button type="button" disabled="" class="fa fa-edit btn btn-warning"    id="editApplicationIndex"   onclick="editApplicationIndex();" style="font-size: large;font-weight: bold;border: 2px solid white;box-shadow: 7px 8px 11px black;"></button>                                               
                                    </div>
                                        ...
                                        <table id="" class="table table-striped table-bordered table-hover" style="text-align: center;font-size: large;">
                                            <thead style="background-color: #337ab7;color: white;">
                                                <tr>
                                                    ...
                                                    <th style="text-align: center;font-size: large;">الترتيب</th>
                                                </tr>
                                            </thead>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="x_panel" style="box-shadow: -1px 2px 5px 1px #929292;">
                                <div class="x_title">
                                    <h2 style="width: 50%;">Application Tab Index Sort</h2>
                                    <ul class="nav navbar-left panel_toolbox" style="direction: ltr;float: left;width: 50%;">
                                        <li><a class="collapse-link"><i class="fa fa-chevron-down"></i></a>
                                        </li>
                                    </ul>
                                ...
                                <div class="x_content" style="display: none;">                                    
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="text-align: left;">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                            <select style="font-size: 15px;font-weight: bold;" type="text" onchange="LoadBasicDataFromApplicationTab();" placeholder="النظام" id="applicationIdS" maxlength="45" name="applicationIdS" class="form-control" required="">                                            
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                            <button type="button" disabled="" class="fa fa-check btn btn-success" id="SaveApplicationTabIndex"   onclick="SaveApplicationTabIndex();" style="font-size: large;font-weight: bold;border: 2px solid white;box-shadow: 7px 8px 11px black;"></button>
                                            <button type="button" disabled="" class="fa fa-close btn btn-danger"    id="cancelApplicationTabIndex" onclick="cancelApplicationTabIndex();" style="font-size: large;font-weight: bold;border: 2px solid white;box-shadow: 7px 8px 11px black;"></button>
                                            <button type="button" disabled="" class="fa fa-edit btn btn-warning"    id="editApplicationTabIndex"   onclick="editApplicationTabIndex();" style="font-size: large;font-weight: bold;border: 2px solid white;box-shadow: 7px 8px 11px black;"></button>                                               
                                        </div>
                            ...
                            <div class="x_panel" style="box-shadow: -1px 2px 5px 1px #929292;">
                                ...
                                <div class="x_content" style="display: none;">                                    
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="text-align: left;">
                                        <!-- start skills -->
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <select style="font-size: 15px;font-weight: bold;" type="text" onchange="LoadSubTabAjax();" placeholder="النظام" id="applicationIdS_2" maxlength="45" name="applicationIdS_2" class="form-control" required="">                                            
                                                <option value="">اختر النظام ...</option>
                                                <%
                                                    for (AppName p : pList) {
                                                %>
                                            ...
                                            <select style="font-size: 15px;font-weight: bold;" type="text" onchange="LoadBasicDataFromApplicationSubTab();" placeholder="النظام" id="applicationTabIdS_2" maxlength="45" name="applicationTabIdS_2" class="form-control" required="">                                            
                                                <option value="">اختر القائمة ...</option>
                                                
                                            </select>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <button type="button" disabled="" class="fa fa-check btn btn-success" id="SaveApplicationSubTabIndex"   onclick="SaveApplicationSubTabIndex();" style="font-size: large;font-weight: bold;border: 2px solid white;box-shadow: 7px 8px 11px black;"></button>
                                            <button type="button" disabled="" class="fa fa-close btn btn-danger"    id="cancelApplicationSubTabIndex" onclick="cancelApplicationSubTabIndex();" style="font-size: large;font-weight: bold;border: 2px solid white;box-shadow: 7px 8px 11px black;"></button>
                                            <button type="button" disabled="" class="fa fa-edit btn btn-warning"    id="editApplicationSubTabIndex"   onclick="editApplicationSubTabIndex();" style="font-size: large;font-weight: bold;border: 2px solid white;box-shadow: 7px 8px 11px black;"></button>                                               
                                        </div>
        ...
        <script src="_9_9_9_9_9_7_Application_Menu_Index_Sort.js"></script>
