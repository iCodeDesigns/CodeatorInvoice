        ...
        b.extend(d.prototype, {
            ...
            runModules: function (c, a) {
                ...
                for (b in this.modules)
                    (p = "object" === typeof a && b in a ? a[b] : a),
                            ...
                            ((this.modules[b].notice = this), (this.modules[b].options = "object" === typeof this.options[b] ? this.options[b] : {}), this.modules[b][c](this, "object" === typeof this.options[b] ? this.options[b] : {}, p));
            },
            state: "initializing",
            timer: null,
            animTimer: null,
            ...
            init: function () {
                ...
                this.container = b("<div />", {
                    class:
                            ...
                            ("error" === this.options.type ? this.styles.error : "info" === this.options.type ? this.styles.info : "success" === this.options.type ? this.styles.success : this.styles.notice),
                    role: "alert",
                }).appendTo(this.elem);
            ...
            update: function (c) {
                ...
                !1 === this.options.title
                        ...
                        : this.options.title !== a.title && (this.options.title_escape ? this.title_container.text(this.options.title) : this.title_container.html(this.options.title), !1 === a.title && this.title_container.slideDown(200));
                !1 === this.options.text
                ...
                this.options.type !== a.type &&
                        this.container
                        .removeClass(this.styles.error + " " + this.styles.notice + " " + this.styles.success + " " + this.styles.info)
                        .addClass("error" === this.options.type ? this.styles.error : "info" === this.options.type ? this.styles.info : "success" === this.options.type ? this.styles.success : this.styles.notice);
            ...
            animateIn: function (c) {
                ...
                "fade" === this.options.animation
                        ? (this.elem.one("webkitTransitionEnd mozTransitionEnd MSTransitionEnd oTransitionEnd transitionend", c).addClass("ui-pnotify-in"),
            ...
            animateOut: function (c) {
                ...
                "fade" === this.options.animation
                        ? (this.elem.one("webkitTransitionEnd mozTransitionEnd MSTransitionEnd oTransitionEnd transitionend", c).removeClass("ui-pnotify-fade-in"), (this.animTimer = setTimeout(c, 650)))
            ...
            position: function (c) {
                ...
                if (a) {
                    ...
                    if (!d || c) {
                        ...
                        if (
                                ("down" === a.dir1 && a.nextpos1 + b.height() > (a.context.is(h) ? n.height() : a.context.prop("scrollHeight"))) ||
                                ("up" === a.dir1 && a.nextpos1 + b.height() > (a.context.is(h) ? n.height() : a.context.prop("scrollHeight"))) ||
                                ("left" === a.dir1 && a.nextpos1 + b.width() > (a.context.is(h) ? n.width() : a.context.prop("scrollWidth"))) ||
                                ("right" === a.dir1 && a.nextpos1 + b.width() > (a.context.is(h) ? n.width() : a.context.prop("scrollWidth")))
                                )
