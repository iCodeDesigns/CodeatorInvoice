...
function f2t(num) {
    ...
    if (fraction.length === 2) {
        ...
        /*if(fraction[1].length === 3){
         if(fraction[1].charAt(2) === "0"){
         fraction[1]=fraction[1].charAt(0)+fraction[1].charAt(1);
         }
         }*/

        //var tafqeetRight = tafqeet (fraction[1]) + ((fraction[1].length>2)?" مليم فقط لا غير":" قرش فقط لا غير");

        if (+fraction[1] === 0) {
            return tafqeet(fraction[0]) + " جنيه لا غير";
        } else {
            return tafqeet(fraction[0]) + " جنيه و" + tafqeet(fraction[1]) + ((fraction[1].length > 2) ? " مليم لا غير" : " قرش لا غير");
        }
